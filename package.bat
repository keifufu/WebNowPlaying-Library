...
7z a %archive64% build\libwnp_win64.lib src\wnp.h CHANGELOG.md README.md LICENSE VERSION
...
7z a %archive64_nodp% build\libwnp_win64_nodp.lib src\wnp.h CHANGELOG.md README.md LICENSE VERSION
...
7z a %archive32% build\libwnp_win32.lib src\wnp.h CHANGELOG.md README.md LICENSE VERSION
...
7z a %archive32_nodp% build\libwnp_win32_nodp.lib src\wnp.h CHANGELOG.md README.md LICENSE VERSION
